...
public class BookTest1 {
	/** 도서 초기화 정보 */
	//일반도서
	public static Book1 b1 = new Book1("21424", "Java Pro", "김하나", "jaen.kr", 15000, "Java 기본문법",10);
	public static Book1 b2 = new Book1("21425", "Java Pro2", "김하나", "jaen.kr", 25000, "Java 응용",20);
	public static Book1 b3 = new Book1("35355", "분석설계        ", "소나무", "jaen.kr", 30000, "SW 모델링",30);
	//잡지
	public static Magazine1 b4 = new Magazine1("45678", "월간 알고리즘 ", "홍길동", "jaen.kr", 10000, "1월 알고리즘", 40, 2021, 1);
	...
	public static void main(String[] args) { // 인터페이스 이용.
		...
		for(Book1 n : mngr1.getMagazines()) {
		...
		for(Book1 n: mngr1.searchByTitle("Java")) {
			System.out.println(n);
		}
		...
		System.out.println(mngr1.sum_price()+"원");
