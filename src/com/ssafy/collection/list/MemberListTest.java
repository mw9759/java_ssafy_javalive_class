...
public class MemberListTest {
	...
	public static void main1(String[] args) {
		...
		Member m6 = m1;
		Member m7 =new Member("user1", "password01", "홍길동", "010-1234-1999", "user01@ssafy.com");
		
		//객체 비교시에는 반드시 equals() 메서드로 할것!!
		System.out.println("-----회원객체 비교 : equals() 재정의시: 아이디가 같으면 같은 객체-----");
		System.out.println("m1= " + m1.hashCode());
		System.out.println("m2= " + m2.hashCode());
		System.out.println("m3= " + m7.hashCode());
		
		System.out.println();
		System.out.println(m1.equals(m2)); //user01과 user02이기에 false
		System.out.println(m1.equals(m7)); //user01과 user01이기에 true
	
		System.out.println();
		System.out.println(m1==m2); //hashCode재정의 : false
		System.out.println(m1==m7); //hashCode재정의 : true => false??
		//해시코드값은 뻥값이다.
		//재정의를 권장하지 할 필요는 없다.
